...
export class ProjectService {
  ...
  private project: Project[] = [
    ...
    new Project(
      'Payroll Analyst Case Study',
      'Excel',
      'Completed seven scenario-based payroll investigations modeled on real analyst workflows, including gross-to-net calculations, discrepancy audits, and multi-period reconciliations',
      [
      ],
      false,
      '',
